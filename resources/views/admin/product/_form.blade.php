...
<div class="form-group">
    ...
    <div class="col-md-10">
        <textarea  name="descriptions" class="form-control" placeholder="Product Description" >{{old('descriptions',isset($product->descriptions)?$product->descriptions:null)}}</textarea>
        @error('descriptions')
        <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-10">
        <input name="unit_price" value="{{ old('unit_price',isset($product->unit_price)?$product->unit_price:null) }}" type="number"step="0.01" class="form-control" placeholder="Enter Unit Price">
        @error('unit_price')
        <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-10">
        <input name="stock" value="{{ old('stock',isset($product->stock)?$product->stock:null) }}" type="number" min="1" class="form-control" placeholder="Product Stock Number">
